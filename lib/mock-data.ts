...
export const mockProjects: Project[] = [
    ...
    { id: "p2", company_id: "co1", customer_id: "c1", name: "Fassadensanierung Müller Bau", address: "Hauptstraße 12, 69115 Heidelberg", status: "aktiv", budget: 24800, progress: 40, start_date: ago(25), end_date: plus(63), color: "#10b981", team: ["e2"], notes: "Gerüststellung erfolgt", created_at: ago(25) },
